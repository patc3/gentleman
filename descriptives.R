...
add_column_from_value_list <- function(tbl, ana)
{
  "
  input: tbl generated by some tbl_fn; ana list of values generated by some ana_fn
  return: tbl with added value column
  "
  ana |>
    unlist() |> 
    data.frame() |> 
...
get_desc_table <- function(df, vars, tbl_fn, group=NULL, ana_fn=NULL, ...)
{
  ...
  if(!is.null(group))
  {
    ...
    if(!is.null(ana_fn))
    {
      ...
      tbl_grp <- tbl_grp |> add_column_from_value_list(ana)
    }
